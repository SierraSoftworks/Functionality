...
Functionality.prototype.any = function(masks) {
	return new Masquerade(function(value) {
		return _.any(arguments, function(mask) { return Masquerade.match(mask, value) });
	});
};

Functionality.prototype.not = function(masks) {
	return new Masquerade(function(value) {
		return value !== undefined && !_.any(arguments, function(mask) { return Masquerade.match(mask, value) });
	});
};
